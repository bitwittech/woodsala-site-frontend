  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="This page contains list of vaiouse type stuff provided by Woodsala."
        />
        <meta
          name="keywords"
          content="category,wooden furniture category,online furniture category,which furniture store is the cheapest,search furniture category"
        />
      </Helmet>
      {/* helmet tag ends  */}
      <title>Collection</title>
